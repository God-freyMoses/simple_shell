This is a Software Engineering (group) project of ALX Holberton school. However due to an unresponsive partner, I ended up doing it alone.
...
* [MAN_simple_shell](MAN_simple_shell) - The Manual describing usage of the simple_shell
 ...
 * Clone the current repository with the command: ```git clone "https://github.com/Monemax94/simple_shell"```
...
## Advanced Tasks
 ...
 - [ ] 22. File as input 
## Author
 Godfrey Moses (godfreymoses203@gmail.com)
